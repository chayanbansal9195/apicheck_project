...
<div class="wrapper row3">
  ...
  ?>
      ...
      <div class="one_half">
        ...
        <h2 style="font-family:'Comic Sans MS', cursive; font-size:24px;">Achievements</h2>
        <span style="font-size:18px">Select Year</span> &nbsp;
        <select name="year" id="year" onChange="showdetails();" style="height:30px; width:100px;">
