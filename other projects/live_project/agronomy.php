...
<?php
$trainq="Select * from trainingactivities where discipline='Agronomy' limit 3";
...
$oftq="Select * from oftactivities where discipline='Agronomy' limit 3";
...
$fldq="Select * from fldactivities where discipline='Agronomy' limit 3";
...
$extraq="Select * from extratraining where discipline='Agronomy' limit 3";
...
$exemq="Select * from exempfarmers where discipline='Agronomy' limit 3";
...
<td width="50%" align="left" style="border-right-style:hidden;">
<?php
$upaq="Select * from upcomingactivities where discipline='Agronomy' limit 3";
