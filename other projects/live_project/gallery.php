...
<div class="wrapper row3">
  ...
  ?>
      ...
      <div class="publication">
        <h2 style="font-family:'Comic Sans MS', cursive; font-size:24px;">Gallery</h2>
        <table width="90%" style="border-style:dashed;">
       <tr>
	   <td><li><a href="video.php" style="color:inherit;">Videos</a></li></td>
       </tr>
       <tr>
	   <td><li><a href="pictures.php" style="color:inherit;">Pictures</a></li></td>
       </tr>
          </table>
