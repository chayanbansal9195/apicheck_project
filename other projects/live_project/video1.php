...
<div class="wrapper row3">
  ...
  ?>
      ...
      <div class="publication">
        <h2 class="footer_title">Video</h2>
        <table width="90%" style="border-style:dashed;">
       <?php
$dfq="Select * from videos";
$dfr=mysql_query($dfq);
while($dfrow=mysql_fetch_array($dfr))
{
	$videos=$dfrow['video'];
	$remarks=$dfrow['remarks'];
?>
<tr>
<td colspan="3"><li><strong><?php echo $remarks; ?></strong></li></td>
</tr>
<tr>
<td width="50%" style="border-right-style:hidden;"><?php 
...
<td width="34%" style="border-right-style:hidden;"><br/><a href="<?php echo $videos; ?>" target="_blank" style="text-decoration:none;"><?php if($videos!='') { ?><img src="images/you.png" width="20" height="20"/> <?php } ?></a></td>
<td width="16%">&nbsp;</td>
</tr>
