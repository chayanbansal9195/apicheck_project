...
<div class="wrapper row3">
  ...
  ?>
      ...
      <div class="one_half">
        ...
        <table width="100%" style="border:hidden;" border="0" bgcolor="#1b4f1f">
        <tr><td style="color:white; font-size:16px;">Website Links</td></tr>
        </table>
          <table width="100%" style="border:hidden;" border="0">
<tr style="font-size:12px;" bgcolor="#c3f4c8">
<td style="text-transform:uppercase; border-right-style:hidden; border-radius:10px;"><a href="https://icar.org.in/" style="color:blue;">Indian Council of Agricultural Research</a></td>
</tr>
<tr style="font-size:12px;" bgcolor="#FFFFFF">
<td style="text-transform:uppercase; border-right-style:hidden;"><a href="http://www.nrcmithun.res.in/" style="color:blue;">ICAR National Research Center on Mithun</a></td>
</tr>
<tr style="font-size:12px;" bgcolor="#c3f4c8">
<td style="text-transform:uppercase; border-right-style:hidden; border-radius:10px;"><a href="http://nrcmithun.in/" style="color:blue;">ICAR Mithun</a></td>
</tr>
          </table>
        </article>
