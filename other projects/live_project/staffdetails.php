  ...
  ?>
      ...
      <div class="one_half">
		...
		?>
          ...
          <td style="border-right-style:hidden;">Name</td>
          <td style="border-right-style:hidden;">Designation</td>
          <td>Email</td>
          </tr>
<?php
$slno=0;
...
<td style="text-transform:uppercase; border-right-style:hidden;"><label onclick="MakePopup(<?php echo $slno;?>)" style="color:#00F;font-size:15px;cursor:pointer;"><?php echo $name; ?></label></td>
<td style="text-transform:uppercase; border-right-style:hidden;"><?php echo $designation; ?></td>
...
?>
		...
		{
			echo "<center><span style='color:#1b4f1f; font-size:16px;'>No Staff Registered Yet</span></center>";
		}
		  ?>
        </article>
...
<script type="text/javascript">
        ...
        function MakePopup(x) {
          //alert(x);
			mywindow=window.open("stafffulldetls.php?serial="+x, "Update Class","status=0,location=0,menubar=0,toolbar=0,resizable=0,height=500,width=900");
