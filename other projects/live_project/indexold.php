  ...
  <div id="container">
    ...
    <div id="homepage" class="clear">
      <div class="one_quarter first">
        ...
        <div class="last">
          <h2 class="nospace font-large">Headline Text</h2>
          <ul class="list decimal">
            <li><a href="#">Donec vestibulum est eget nulla.</a></li>
            <li><a href="#">Vestibulum at nulla eu est mole.</a></li>
            <li><a href="#">Ut in est orci, scelerisque.</a></li>
            <li><a href="#">Proin tempor luctus arcu.</a></li>
            <li><a href="#">Nullam dictum erat vel tortor.</a></li>
            <li><a href="#">Donec condimentum dui eu dolor.</a></li>
          </ul>
        </div>
      </div>
      <!-- ################################################################################################ -->
      <div class="one_half">
        <article class="push20">
          <div class="push30"><a href="#"><img src="images/demo/gallery.gif" alt=""></a></div>
          <h2>Headline Text</h2>
          <p>Aliquatjusto quisque nam consequat doloreet vest orna partur scetur portortis nam. Metadipiscing eget facilis elit sagittis felisi eger id justo maurisus convallicitur.</p>
        </article>
        <ul class="nospace spacing center clear">
          <li class="one_quarter first"><a href="#"><img src="images/demo/gallery.gif" alt=""><br>
            Link Text Here</a></li>
          <li class="one_quarter"><a href="#"><img src="images/demo/gallery.gif" alt=""><br>
            Link Text Here</a></li>
          <li class="one_quarter"><a href="#"><img src="images/demo/gallery.gif" alt=""><br>
            Link Text Here</a></li>
          <li class="one_quarter"><a href="#"><img src="images/demo/gallery.gif" alt=""><br>
      ...
      <div class="one_quarter">
        <div class="push20"><a href="#"><img src="images/demo/video.gif" alt=""></a></div>
        <div class="push20"><a href="#"><img src="images/demo/video.gif" alt=""></a></div>
        <article class="push20">
          <div class="push30"><img src="images/demo/1200x400.gif" alt=""></div>
          <p class="bold uppercase nospace"><a href="#">Headline Text</a></p>
          <p class="nospace">Aliquatjusto quisque nam consequat doloreet vest orna partur scetur portortis nam.</p>
        </article>
        <article>
          <div class="push30"><img src="images/demo/1200x400.gif" alt=""></div>
          <p class="bold uppercase nospace"><a href="#">Headline Text</a></p>
      ...
      <div class="one_half first">
        <div class="tab-wrapper clear">
          <ul class="tab-nav clear">
            <li><a href="#tab-1">Category 1</a></li>
            <li><a href="#tab-2">Category 2</a></li>
            <li><a href="#tab-3">Category 3</a></li>
            <li><a href="#tab-4">Category 4</a></li>
          </ul>
      ...
      <div class="one_half">
        <article class="push20 clear">
          <div class="imgl boxholder"><img src="images/demo/120x120.gif" alt=""></div>
          <h2>Headline Text</h2>
          <p>Aliquatjusto quisque nam consequat doloreet vest orna partur scetur portortis nam. Metadipiscing eget facilis elit sagittis felisi eger id justo maurisus convallicitur.</p>
          <footer class="read-more"><a href="#">Read More &raquo;</a></footer>
        </article>
