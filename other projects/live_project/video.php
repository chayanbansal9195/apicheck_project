...
<table width="100%">
<tr bgcolor="#59004a">
<td style="color:white; font-size:18px;" align="center"><strong>Videos</strong></td>
</tr>
</table>
<?php
date_default_timezone_set("Asia/Kolkata");
$syear=date("Y");
$query007="Select * from videos";
...
<?php
	...
	if($rows007)
	{
	$videos=$rows007['video'];
	$remarks=$rows007['remarks'];
...
src="<?php echo $embedvideos; ?>" frameborder="0">
						...
						<tr><td><a href="<?php echo $videos; ?>" target="_blank" style="text-decoration:none;"><?php echo $remarks; ?></a>
				</td></tr>
