      ...
      <div class="one_half">
        <article class="push20">
         ...
         <div class="w3-content w3-section" style="max-width:700px">
  		<img class="mySlides0 w3-animate-left" src="images/kvkphoto.jpg" style="width:800px; height:360px">
  		<img class="mySlides0 w3-animate-right" src="images/kvkphoto4.jpg" style="width:800px; height:360px">
        <img class="mySlides0 w3-animate-left" src="images/kvkphoto2.jpg" style="width:800px; height:360px">
        <img class="mySlides0 w3-animate-right" src="images/kvkphoto1.jpg" style="width:800px; height:360px">
  		<img class="mySlides0 w3-animate-left" src="images/kvkphoto3.png" style="width:800px; height:360px">
        <img class="mySlides0 w3-animate-right" src="images/kvkphoto5.jpg" style="width:800px; height:360px">	
	  </div>
          </a></div>
...
function carousel0() {
    var l;
    var w = document.getElementsByClassName("mySlides0");
    for (l = 0; l < w.length; l++) {
       w[l].style.display = "none";  
    }
    myIndex0++;
    if (myIndex0 > w.length) {myIndex0 = 1}    
    w[myIndex0-1].style.display = "block";  
    setTimeout(carousel0, 4000);
}
