...
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4><i class="fa fa-user fa-fw"></i>Annual Report</h4>
        </div>
        <!-- /.panel-heading -->
        ...
        <?php
            ...
            ?>
          <form name="a" action="master/annualreportaction.php" method="post" enctype="multipart/form-data"> 
    ...
    <?php
      $sl=1;
        $find_user="SELECT * from annualreport";
...
<div class="col-lg-12">
  <div class="panel panel-default">
    <div class="panel-body">
    <form name="ab" method="post" action="master/deleteannualreport.php">
