	...
	include('../connect.php');
	  ...
	  {
		  $find_user="SELECT * from oftactivities where discipline='$discipline'";
	  }
	  if($discipline=='' && $year!='0000')
	  {
		  $find_user="SELECT * from oftactivities where activity_date Like '$year%'";
	  }
	  if($discipline!='' && $year!='0000')
	  {
       $find_user="SELECT * from oftactivities where discipline='$discipline' and activity_date Like '$year%'";
	  }
...
<form name="ab" method="post" action="master/deleteoftentry.php">
  ...
  <td align="center"><a href="api.php?link=0OFTEDT&id=<?php echo $act_id; ?>"><img src="images/edit.png" width="30" height="30" /></a></td>
