...
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4><i class="fa fa-image fa-fw"></i>Upload Photos for Success Stories</h4>
        </div>
        <!-- /.panel-heading -->
        <div class="panel-body">
        <?php
				if (isset($_SESSION['ROLLSSDElSUC'])) {
                 //echo "<span class='alert alert-success'>".$success."</span>";
                echo '<div class = "alert alert-danger alert-dismissable">
                    <button type = "button" class = "close" data-dismiss = "alert" aria-hidden = "true">
                    &times;
                    </button>'.$_SESSION['ROLLSSDElSUC'].'
                    </div>';
                unset($_SESSION['ROLLSSDElSUC']);
                }
				
				if (isset($_SESSION['ROLLSSSUC'])) {
                 //echo "<span class='alert alert-success'>".$success."</span>";
                echo '<div class = "alert alert-success alert-dismissable">
                    <button type = "button" class = "close" data-dismiss = "alert" aria-hidden = "true">
                    &times;
                    </button>'.$_SESSION['ROLLSSSUC'].'
                    </div>';
                unset($_SESSION['ROLLSSSUC']);
                }
            
				$login=$_SESSION['LOGIN'];
            ?>
          <form name="a" method="post" action="master/rolloversuccessstories_action.php" enctype="multipart/form-data" 
...
<br>
<?php
$query007="Select * from rolloversuccessstories";
...
include('connect.php');
?>
<form name="a" method="post" action="master/rolloversuccessstories_delete_action.php" enctype="multipart/form-data">
<?php
function valid($x,$y){
	$flag=0;
	$qry="SELECT * from rolloversuccessstories where id='$x' AND photos='$y'";
	$rsl=mysql_query($qry) ;
