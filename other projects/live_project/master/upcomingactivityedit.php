...
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4><i class="fa fa-user fa-fw"></i>Edit Upcoming Activity</h4>
        </div>
        <!-- /.panel-heading -->
        ...
        <?php
				...
				extract($_GET);
				include('connect.php');
				$find_user="SELECT * from upcomingactivities where slno='$id'";
            ...
            ?>
          <form name="a" action="master/upcomingactivityeditaction.php" method="post" enctype="multipart/form-data"> 
          <input type="hidden" name="slno" id="slno" value="<?php echo $act_id; ?>" />
           ...
           <tr>
                <td width="258" height="51"><span style="font-size:1vw;"><em>Activity:</em></span></td>
