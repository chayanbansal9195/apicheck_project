...
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4><i class="fa fa-user fa-fw"></i>Edit Other Report</h4>
        </div>
        <!-- /.panel-heading -->
        ...
        <?php
				...
				extract($_GET);
				include('connect.php');
				$find_user="SELECT * from otherreport where slno='$id'";
            ...
            ?>
          <form name="a" action="master/otherreporteditaction.php" method="post" enctype="multipart/form-data"> 
