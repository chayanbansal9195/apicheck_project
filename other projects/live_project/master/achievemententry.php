...
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4><i class="fa fa-user fa-fw"></i>Achievement Entry</h4>
        </div>
        <!-- /.panel-heading -->
        ...
        <?php
            ...
            ?>
          <form name="a" action="master/achievemententryaction.php" method="post" enctype="multipart/form-data"> 
    ...
    <?php
      $sl=1;
        $find_user="SELECT * from achievements";
...
<div class="col-lg-12">
  <div class="panel panel-default">
    <div class="panel-body">
    <form name="ab" method="post" action="master/deleteachievemnt.php">
    <table class="table table-striped table-hover" width="100%">
      <thead>
        <tr>
          <th width="8%" style="text-align:center">SL. NO.</th>
          <th width="44%" style="text-align:center">Achievement</th>
  ...
  <td align="center"><a href="api.php?link=0ACHVEDT&id=<?php echo $news_id; ?>"><img src="images/edit.png" width="30" height="30" /></a></td>
