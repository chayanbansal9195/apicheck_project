...
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4><i class="fa fa-user fa-fw"></i>FLD Entry</h4>
        </div>
        <!-- /.panel-heading -->
        ...
        <?php
            ...
            ?>
          <form name="a" action="master/fldentryaction.php" method="post" enctype="multipart/form-data"> 
		 ...
		 var httpx;
                      ...
                      httpx=new XMLHttpRequest();
                       ...
                       httpx=new ActiveXObject("Microsoft.XMLHTTP");
                           ...
                           httpx.open("GET","master/fldentry_ajax.php?dte="+datastring,true);
