...
?>
<form name="a" method="post" action="master/delete_uploaded_photos_action.php" enctype="multipart/form-data">
<?php
function valid($x,$y,$z){
	$flag=0;
	$qry="SELECT * from eventphotos where id='$x' AND event_photos='$y' AND login='$z'";
	$rsl=mysql_query($qry) ;
	$nf=mysql_num_rows($rsl);
	return $nf;
}
$query007="Select * from eventphotos where event_code='$ecode' and login='$login'";
...
<br>
<br>
<center><h2 style="color:red; text-align:center">
<?php
$query="Select * from eventphotos where event_code='$ecode' and login='$login'";
...
<br>
    ...
    <td height="28"><div class="panel panel-primary">
     <div class="panel-body"><?php echo "<img src='eventphoto/$photo1' style='width:12vw; height:9vw;' onclick='openModal();currentSlide($c)' class='hover-shadow' onmouseover='bigImg(this)' onmouseout='normalImg(this)' />";?></div></div>
<center><input type="checkbox" name="checkbox[]" class="checkbox" id=<?php echo $c; ?> <?php $nf=valid($id,$photo1,$login);?> onClick="checkValid(this)" value="<?php echo $id; ?>" /></center>
     <!--<tr><input type="checkbox" name="checkbox[]" class="checkbox" id=<?php echo $c; ?> <?php $nf=valid($id,$photo1,$login);?> onClick="checkValid(this)" value="<?php echo $id; ?>" /></tr>-->
    </td>
    </tr>
    </table><br /><br />
...
<div id="myModal" class="modal gallery"> <span class="close cursor" onClick="closeModal()">&times;</span>
  ...
  <?php
  $qry007="Select * from eventphotos where event_code='$ecode' and login='$login'";
