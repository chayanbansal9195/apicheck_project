...
$mainfile = "../rollover/KVKHOME". $file_name;
$finalfile= "KVKHOME". $file_name;
...
$q21="Insert into rolloverhome(photos, date, datetime) values('$finalfile','$sdate','$sdatetime')";
$r21=mysql_query($q21);
$_SESSION['ROLLHOMESUC']="Successfully Uploaded...";
header("location:../api.php?link=0ROHOME");
