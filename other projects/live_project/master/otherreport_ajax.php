...
$gtvalue=$_GET['dte'];
	...
	include('../connect.php');
      $sl=1;
        $find_user="SELECT * from otherreport  where date>='$fdate' and date<='$tdate'";
...
<div class="col-lg-12">
  <div class="panel panel-default">
    ...
    <form name="ab" method="post" action="master/deleteotherreport.php">
    <table class="table table-striped table-hover" width="100%">
      <thead>
        <tr>
          <th width="8%" style="text-align:center">SL. NO.</th>
          <th width="44%" style="text-align:center">Report</th>
  ...
  <td align="center"><a href="api.php?link=0OTRPEDT&id=<?php echo $news_id; ?>"><img src="images/edit.png" width="30" height="30" /></a></td>
