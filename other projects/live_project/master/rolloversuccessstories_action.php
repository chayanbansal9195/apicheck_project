...
$mainfile = "../rollover/KVKSS". $file_name;
$finalfile= "KVKSS". $file_name;
...
$q21="Insert into rolloversuccessstories(photos, caption, date, datetime) values('$finalfile','$caption','$sdate','$sdatetime')";
$r21=mysql_query($q21);
$_SESSION['ROLLSSSUC']="Successfully Uploaded...";
