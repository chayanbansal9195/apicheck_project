...
if($_FILES['doc']['name']!='')
{
$select="select * from trainingactivities where slno='$slno'";
...
{
$q213="update trainingactivities set training='$activity', doc_file='$file_name' where slno='$slno'";
...
{
$q213="update trainingactivities set training='$activity' where slno='$slno'";
$r213=mysql_query($q213);
$_SESSION['HOUSE_suc']="Successfully Updated...";
header("location:../api.php?link=0TRNACTVTS");		
}
