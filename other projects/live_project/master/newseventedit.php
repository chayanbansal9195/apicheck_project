...
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4><i class="fa fa-user fa-fw"></i>Edit News & Event</h4>
        </div>
        <!-- /.panel-heading -->
        ...
        <?php
				...
				extract($_GET);
				include('connect.php');
				$find_user="SELECT * from newsevent where slno='$id'";
				$find_user_run=mysql_query($find_user);
				while ($row=mysql_fetch_array($find_user_run)) {
			 $act_id=$row['slno'];
			 $activity=$row['news_event'];
			 $file=$row['doc_file'];
				}
            ?>
          <form name="a" action="master/newseventeditaction.php" method="post" enctype="multipart/form-data"> 
