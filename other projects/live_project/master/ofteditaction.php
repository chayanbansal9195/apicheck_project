...
if($_FILES['doc']['name']!='')
{
$select="select * from oftactivities where slno='$slno'";
...
{
$q213="update oftactivities set oft='$activity', doc_file='$file_name' where slno='$slno'";
...
{
$q213="update oftactivities set oft='$activity' where slno='$slno'";
$r213=mysql_query($q213);
$_SESSION['HOUSE_suc']="Successfully Updated...";
header("location:../api.php?link=0OFTACTVTS");		
}
