...
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4><i class="fa fa-user fa-fw"></i>OFT Edit</h4>
        </div>
        <!-- /.panel-heading -->
        ...
        <?php
				...
				extract($_GET);
				include('connect.php');
				$find_user="SELECT * from oftactivities where slno='$id'";
            ...
            ?>
          <form name="a" action="master/ofteditaction.php" method="post" enctype="multipart/form-data"> 
