...
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4><i class="fa fa-user fa-fw"></i>Videos</h4>
        </div>
        <!-- /.panel-heading -->
        ...
        <?php
            ...
            ?>
          <form name="a" action="master/uploadvdoaction.php" method="post"> 
          <input type="hidden" name="login" id="login" value="<?php echo $login; ?>" />
            <table width="43%"  border="0" align="center">
           <tr>
                <td width="123" height="51"><span style="font-size:1vw;"><em>Video:</em></span></td>
                <td width="420"><textarea name="video" id="video" style="width:99%;padding:6px 12px;font-size:14px;line-height:1.42857143;color:#555;background-color:#fff;background-image:none;border:1px solid #ccc;border-radius:4px;-webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,.075);box-shadow:inset 0 1px 1px rgba(0,0,0,.075);-webkit-transition:border-color ease-in-out .15s,-webkit-box-shadow ease-in-out .15s;-o-transition:border-color ease-in-out .15s,box-shadow ease-in-out .15s;transition:border-color ease-in-out .15s,box-shadow ease-in-out .15s" required="required"></textarea>
                </td>
              </tr>
<tr>
                <td width="123" height="51"><span style="font-size:1vw;"><em>Date:</em></span></td>
                <td width="420"><input type="text" name="date" id="date" required="required" readonly="readonly" style="width:50%;height:34px;padding:6px 12px;font-size:14px;line-height:1.42857143;color:#555;background-color:#fff;background-image:none;border:1px solid #ccc;border-radius:4px;-webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,.075);box-shadow:inset 0 1px 1px rgba(0,0,0,.075);-webkit-transition:border-color ease-in-out .15s,-webkit-box-shadow ease-in-out .15s;-o-transition:border-color ease-in-out .15s,box-shadow ease-in-out .15s;transition:border-color ease-in-out .15s,box-shadow ease-in-out .15s">
                        <i class="glyphicon glyphicon-calendar"></i>
                </td>
              </tr>
              <tr>
                <td width="258" height="51"><span style="font-size:1vw;"><em>Remarks:</em></span></td>
                <td width="392"><Textarea name="remarks" id="remarks" rows="4" style="width:80%;padding:6px 12px;font-size:14px;line-height:1.42857143;color:#555;background-color:#fff;background-image:none;border:1px solid #ccc;border-radius:4px;-webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,.075);box-shadow:inset 0 1px 1px rgba(0,0,0,.075);-webkit-transition:border-color ease-in-out .15s,-webkit-box-shadow ease-in-out .15s;-o-transition:border-color ease-in-out .15s,box-shadow ease-in-out .15s;transition:border-color ease-in-out .15s,box-shadow ease-in-out .15s" required="required"></Textarea>
                </td>
              </tr>
              <tr>
                <td width="39%" height="63">&nbsp;</td>
                <td width="61%">
...
<div class="col-lg-12">
  <div class="panel panel-default">
    ...
    <table width="43%"  border="0" align="center">
    <tr>
                <td width="112" height="51"><span style="font-size:1vw;"><em>From Date:</em></span></td>
               <td width="211"><input type="text" name="fdate" id="fdate" required="required" readonly="readonly" style="width:50%;height:34px;padding:6px 12px;font-size:14px;line-height:1.42857143;color:#555;background-color:#fff;background-image:none;border:1px solid #ccc;border-radius:4px;-webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,.075);box-shadow:inset 0 1px 1px rgba(0,0,0,.075);-webkit-transition:border-color ease-in-out .15s,-webkit-box-shadow ease-in-out .15s;-o-transition:border-color ease-in-out .15s,box-shadow ease-in-out .15s;transition:border-color ease-in-out .15s,box-shadow ease-in-out .15s">&nbsp;<i class="glyphicon glyphicon-calendar"></i></td>
                <td width="90" height="51"><span style="font-size:1vw;"><em>To Date:</em></span></td>
                <td width="211">
		 ...
		 var httpx;
                      ...
                      httpx=new XMLHttpRequest();
                       ...
                       httpx=new ActiveXObject("Microsoft.XMLHTTP");
                           ...
                           httpx.open("GET","master/uploadvdo_ajax.php?dte="+datastring,true);
