	...
	include('../connect.php');
	  ...
	  {
		  $find_user="SELECT * from trainingactivities where discipline='$discipline'";
	  }
	  if($discipline=='' && $year!='0000')
	  {
		  $find_user="SELECT * from trainingactivities where activity_date Like '$year%'";
	  }
	  if($discipline!='' && $year!='0000')
	  {
       $find_user="SELECT * from trainingactivities where discipline='$discipline' and activity_date Like '$year%'";
	  }
...
<div class="col-lg-12">
  <div class="panel panel-default">
    ...
    <form name="ab" method="post" action="master/deletetraining.php">
  ...
  <td align="center"><a href="api.php?link=0TRANGEDT&id=<?php echo $act_id; ?>"><img src="images/edit.png" width="30" height="30" /></a></td>
