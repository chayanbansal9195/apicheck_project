...
{
echo $q213="Insert into extratraining(discipline, training, doc_file, activity_date, datetime, login) values('$discipline','$activity','$file_name','$date','$sdatetime','$login')";
...
{
$q213="Insert into extratraining(discipline, training, doc_file, activity_date, datetime, login) values('$discipline','$activity','','$date','$sdatetime','$login')";
$r213=mysql_query($q213);
$_SESSION['HOUSE_suc']="Successfully Uploaded...";
header("location:../api.php?link=0EXTRACTVTS");		
}
