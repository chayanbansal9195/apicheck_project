	...
	include('../connect.php');
	  ...
	  {
		  $find_user="SELECT * from upcomingactivities where discipline='$discipline'";
	  }
	  if($discipline=='' && $year!='0000')
	  {
		  $find_user="SELECT * from upcomingactivities where activity_date Like '$year%'";
	  }
	  if($discipline!='' && $year!='0000')
	  {
       $find_user="SELECT * from upcomingactivities where discipline='$discipline' and activity_date Like '$year%'";
	  }
...
<div class="col-lg-12">
  <div class="panel panel-default">
    ...
    <form name="ab" method="post" action="master/deleteupcomingactivities.php">
    <table class="table table-striped table-hover" width="100%">
      <thead>
        <tr>
          <th width="8%" style="text-align:center">SL. NO.</th>
          <th width="17%" style="text-align:center">Discipline</th>
          <th width="42%" style="text-align:center">Activity</th>
  ...
  <a href="upload_docs/<?php echo $file; ?>" target="_blank"><img src="images/pdf.gif"/></a> <?php } ?></td>
   <td align="center"><a href="api.php?link=0UPCAEDT&id=<?php echo $act_id; ?>"><img src="images/edit.png" width="30" height="30" /></a></td>
