...
if($_FILES['doc']['name']!='')
{
$select="select * from fldactivities where slno='$slno'";
...
{
$q213="update fldactivities set fld='$activity', doc_file='$file_name' where slno='$slno'";
...
{
$q213="update fldactivities set fld='$activity' where slno='$slno'";
$r213=mysql_query($q213);
$_SESSION['HOUSE_suc']="Successfully Updated...";
header("location:../api.php?link=0FLDACTVTS");		
}
