...
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4><i class="fa fa-image fa-fw"></i>Upload Photos for Farmers Innovation</h4>
        </div>
        <!-- /.panel-heading -->
        <div class="panel-body">
        <?php
				if (isset($_SESSION['ROLLFIDElSUC'])) {
                 //echo "<span class='alert alert-success'>".$success."</span>";
                echo '<div class = "alert alert-danger alert-dismissable">
                    <button type = "button" class = "close" data-dismiss = "alert" aria-hidden = "true">
                    &times;
                    </button>'.$_SESSION['ROLLFIDElSUC'].'
                    </div>';
                unset($_SESSION['ROLLFIDElSUC']);
                }
				
				if (isset($_SESSION['ROLLFISUC'])) {
                 //echo "<span class='alert alert-success'>".$success."</span>";
                echo '<div class = "alert alert-success alert-dismissable">
                    <button type = "button" class = "close" data-dismiss = "alert" aria-hidden = "true">
                    &times;
                    </button>'.$_SESSION['ROLLFISUC'].'
                    </div>';
                unset($_SESSION['ROLLFISUC']);
                }
            
				$login=$_SESSION['LOGIN'];
            ?>
          <form name="a" method="post" action="master/rolloverfarmersinnovation_action.php" enctype="multipart/form-data" 
onsubmit="return FileDetails();">
<input type="hidden" name="user" id="user" value="<?php echo $login; ?>" />
            <table border="0" align="center">
           <tr>
                <td width="263" height="51"><span style="font-size:1.3vw;"><em>Caption:</em></span></td>
                <td width="459"><textarea rows="5" id="event" name="caption" size="20" class="textarea" placeholder="Enter Caption" required autocomplete="off"></textarea>
                </td>
              </tr>
             <tr>
             <td width="263" height="60"><span style="font-size:1.3vw;"><em>Upload Photos:</em></span></td>
             <td width="459"><input type="file" name="photo" id="photo" required accept="image/*" />
...
<br>
<?php
$query007="Select * from rolloverfarmersinnovation";
...
include('connect.php');
?>
<form name="a" method="post" action="master/rolloverfarmersinnovation_delete_action.php" enctype="multipart/form-data">
<?php
function valid($x,$y){
	$flag=0;
	$qry="SELECT * from rolloverfarmersinnovation where id='$x' AND photos='$y'";
	$rsl=mysql_query($qry) ;
...
<br>
    ...
    <td height="28"><div class="panel panel-primary">
     <div class="panel-body"><?php echo "<img src='rollover/$photo1' style='width:12vw; height:9vw;' onclick='openModal();currentSlide($c)' class='hover-shadow' onmouseover='bigImg(this)' onmouseout='normalImg(this)' />";?></div>
     <p align="center"><?php echo $caption; ?></p></div>
...
<div id="myModal" class="modal gallery"> <span class="close cursor" onClick="closeModal()">&times;</span>
  ...
  <?php
  $qry007="Select * from rolloverfarmersinnovation";
