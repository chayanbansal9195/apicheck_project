...
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4><i class="fa fa-user fa-fw"></i>Documentary Films</h4>
        </div>
        <!-- /.panel-heading -->
		 ...
		 var httpx;
                      ...
                      httpx=new XMLHttpRequest();
                       ...
                       httpx=new ActiveXObject("Microsoft.XMLHTTP");
                           ...
                           httpx.open("GET","master/documntfilm_ajax.php?dte="+datastring,true);
