...
<div class="col-lg-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4><i class="fa fa-user fa-fw"></i>Edit Training to Extra Functionaries</h4>
        </div>
        <!-- /.panel-heading -->
        ...
        <?php
				...
				extract($_GET);
				include('connect.php');
				$find_user="SELECT * from extratraining where slno='$id'";
            ...
            ?>
          <form name="a" action="master/extractivityeditaction.php" method="post" enctype="multipart/form-data"> 
          <input type="hidden" name="slno" id="slno" value="<?php echo $act_id; ?>" />
            ...
            <tr>
               ...
               <td><input type="text" name="discipline" id="discipline" required="required" readonly="readonly" style="width:50%;height:34px;padding:6px 12px;font-size:14px;line-height:1.42857143;color:#555;background-color:#fff;background-image:none;border:1px solid #ccc;border-radius:4px;-webkit-box-shadow:inset 0 1px 1px rgba(0,0,0,.075);box-shadow:inset 0 1px 1px rgba(0,0,0,.075);-webkit-transition:border-color ease-in-out .15s,-webkit-box-shadow ease-in-out .15s;-o-transition:border-color ease-in-out .15s,box-shadow ease-in-out .15s;transition:border-color ease-in-out .15s,box-shadow ease-in-out .15s" value="<?php echo $discipline; ?>"></td>
              </tr>
           <tr>
                <td width="258" height="51"><span style="font-size:1vw;"><em>Training:</em></span></td>
