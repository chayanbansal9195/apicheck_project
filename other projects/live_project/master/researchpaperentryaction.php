...
$file_name="RSPAPER".$exjoin1 .'.' .$ext;
$extension = end((explode(".", $file_name)));
$target_path = $target_path.$file_name;

if(move_uploaded_file($_FILES['doc']['tmp_name'], $target_path))
{
$q213="Insert into researchpaper(heading, doc_file, date, login) values('$heading','$file_name','$date','$login')";
$r213=mysql_query($q213);
$_SESSION['HOUSE_suc']="Successfully Uploaded...";
header("location:../api.php?link=0RSRCHPPR");
}
else
{
$q213="Insert into researchpaper(heading, doc_file, date, login) values('$heading','','$date','$login')";
$r213=mysql_query($q213);
$_SESSION['HOUSE_suc']="Successfully Uploaded...";
header("location:../api.php?link=0RSRCHPPR");
}
