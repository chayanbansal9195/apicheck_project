...
<tr>
<td style="border-bottom-style:ridge;"><b><span style="color:#8c0075; font-size:16px;">Exemplenary Farmers</span></b></td>
</tr>
<?php
include('connect.php');
$link=$_GET['link'];
$exemq="Select * from exempfarmers where discipline='$link'";
