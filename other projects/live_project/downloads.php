...
<div class="wrapper row3">
  ...
  ?>
      ...
      <div class="one_half">
        ...
        <h2 style="font-family:'Comic Sans MS', cursive; font-size:24px;">Downloads</h2>
        <?php
		$query007="Select * from downloads";
...
?>
		...
		{
			echo "<center><span style='color:#1b4f1f; font-size:16px;'>No Record Found...</span></center>";
		}
		  ?>
        </article>
