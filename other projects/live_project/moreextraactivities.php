...
<tr>
<td style="border-bottom-style:ridge;"><b><span style="color:#8c0075; font-size:16px;">Training to Extra Functionaries</span></b></td>
</tr>
<?php
include('connect.php');
$link=$_GET['link'];
$extraq="Select * from extratraining where discipline='$link'";
