...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 23, 2018 at 03:33 AM
...
DROP TABLE IF EXISTS `annualreport`;
...
DROP TABLE IF EXISTS `contactstaff`;
...
DROP TABLE IF EXISTS `documentaryfilm`;
...
DROP TABLE IF EXISTS `exempfarmers`;
...
DROP TABLE IF EXISTS `extratraining`;
...
DROP TABLE IF EXISTS `fldactivities`;
...
DROP TABLE IF EXISTS `newspaperpublication`;
...
DROP TABLE IF EXISTS `oftactivities`;
...
DROP TABLE IF EXISTS `rolloveradvisories`;
...
DROP TABLE IF EXISTS `rolloverfarmersinnovation`;
...
DROP TABLE IF EXISTS `rolloverhome`;
...
DROP TABLE IF EXISTS `rolloversuccessstories`;
...
DROP TABLE IF EXISTS `technicalbook`;
...
DROP TABLE IF EXISTS `upcomingactivities`;
...
DROP TABLE IF EXISTS `zoneannualreport`;
