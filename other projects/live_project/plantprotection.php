...
<table width="100%">
<tr bgcolor="#59004a">
<td style="color:white; font-size:18px;" align="center"><strong>Plant Protection</strong></td>
</tr>
</table>
...
<?php
$trainq="Select * from trainingactivities where discipline='Plant Protection' limit 3";
...
$oftq="Select * from oftactivities where discipline='Plant Protection' limit 3";
...
$fldq="Select * from fldactivities where discipline='Plant Protection' limit 3";
...
$extraq="Select * from extratraining where discipline='Plant Protection' limit 3";
...
$exemq="Select * from exempfarmers where discipline='Plant Protection' limit 3";
...
<td width="50%" align="left" style="border-right-style:hidden;">
<?php
$upaq="Select * from upcomingactivities where discipline='Plant Protection' limit 3";
